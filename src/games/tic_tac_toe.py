"""
tic_tac_toe.py  defines the TicTacToeGame class, which provides a text-based
version of the classic Tic-Tac-Toe game. Players can choose their side (X or O)
and play against a simple AI. The game manages turns, win/draw detection,
and board rendering in ASCII.
"""
